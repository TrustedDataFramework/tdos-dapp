...
export function init(endTime: string): void {
    ...
    Globals.set<ArrayBuffer>('serialArrayList', encodeStrings(serialArray))
    log('权限合约已部署');
}
...
export function setSerial(serial: string): void {
    ...
    let serialArrayList = Globals.get<ArrayBuffer>('serialArrayList');
    let serialStringList = decodeStrings(serialArrayList);
    serialStringList.push(serial);
    Globals.set<ArrayBuffer>('serialArrayList', encodeStrings(serialStringList));
...
export function getSerials(): ArrayBuffer {
    return Globals.get<ArrayBuffer>('serialArrayList');
}
